...
def main(args, init_distributed=False):
    ...
    if args.train_subtransformer:
        ...
        import json
        dummy=True
        w = open("/scratch/objects/nas-moe/jul5_fine_latency_pred_feats/moe_2e/model_sizes/wmt14.en-de_gpu_titanxp_dummy.csv", "w")
        for line in open("/scratch//objects/nas-moe/jul5_fine_latency_pred_feats/moe_2e/genlatdata/wmt14.en-de_gpu_titanxp_dummy.csv"):
            line = line.strip()
